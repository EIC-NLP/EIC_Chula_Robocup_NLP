...
PARAMETERS = {
    'AECFREEZEONOFF':
    (18, 7, 'int', 1, 0, 'rw', 'Adaptive Echo Canceler updates inhibit.',
    ...
    'NONSTATNOISEONOFF': (19, 11, 'int', 1, 0, 'rw',
                          'Non-stationary noise suppression.', '0 = OFF',
                          '1 = ON'),
    'GAMMA_NN':
    (19, 12, 'float', 3, 0, 'rw',
    ...
    'ECHOONOFF': (19, 14, 'int', 1, 0, 'rw', 'Echo suppression.', '0 = OFF',
                  '1 = ON'),
    'GAMMA_E':
    (19, 15, 'float', 3, 0, 'rw',
    ...
    'STATNOISEONOFF_SR': (19, 33, 'int', 1, 0, 'rw',
                          'Stationary noise suppression for stt.', '0 = OFF',
                          '1 = ON'),
    'NONSTATNOISEONOFF_SR': (19, 34, 'int', 1, 0, 'rw',
                             'Non-stationary noise suppression for stt.',
                             '0 = OFF', '1 = ON'),
    'GAMMA_NS_SR': (19, 35, 'float', 3, 0, 'rw',
                    'Over-subtraction factor of stationary noise for stt. ',
                    '[0.0 .. 3.0] (default: 1.0)'),
    'GAMMA_NN_SR':
    (19, 36, 'float', 3, 0, 'rw',
     'Over-subtraction factor of non-stationary noise for stt. ',
     '[0.0 .. 3.0] (default: 1.1)'),
    'MIN_NS_SR': (19, 37, 'float', 1, 0, 'rw',
                  'Gain-floor for stationary noise suppression for stt.',
                  '[-inf .. 0] dB (default: -16dB = 20log10(0.15))'),
    'MIN_NN_SR': (19, 38, 'float', 1, 0, 'rw',
                  'Gain-floor for non-stationary noise suppression for stt.',
                  '[-inf .. 0] dB (default: -10dB = 20log10(0.3))'),
...
class Tuning:
    ...
    def write(self, name, value):
        ...
        self.dev.ctrl_transfer(
            ...
            | usb.util.CTRL_RECIPIENT_DEVICE, 0, 0, id, payload, self.TIMEOUT)
    ...
    def read(self, name):
        ...
        response = self.dev.ctrl_transfer(
            ...
            | usb.util.CTRL_RECIPIENT_DEVICE, 0, cmd, id, length, self.TIMEOUT)
    ...
    def version(self):
        return self.dev.ctrl_transfer(
            usb.util.CTRL_IN | usb.util.CTRL_TYPE_VENDOR
            | usb.util.CTRL_RECIPIENT_DEVICE, 0, 0x80, 0, 1, self.TIMEOUT)[0]
